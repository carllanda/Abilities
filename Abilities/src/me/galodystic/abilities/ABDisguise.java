...
public class ABDisguise extends JavaPlugin{
	...
	public void disguise(Player player, MobType mob) {
		...
		if (!dcapi.isDisguised(player)) {
			...
			BGChat.printPlayerChat(player, plugin.config.readString("Abilities.90.disguise"));
			hidePlayer(player);
			disList.add(player);
	...
	public void unDisguise(Player player) {
		...
		if (dcapi.isDisguised(player)) {
			...
			BGChat.printPlayerChat(player, plugin.config.readString("Abilities.90.undisguise"));
			showPlayer(player);
